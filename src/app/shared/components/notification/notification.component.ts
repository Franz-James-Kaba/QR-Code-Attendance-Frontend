...
export class NotificationComponent implements OnInit, OnDestroy {
  ...
  private updatePositionClass(): void {
    ...
    const positionClasses = {
      ...
      'top-center': 'fixed top-4 left-1/2 -translate-x-1/2 z-50 flex flex-col gap-2 w-full max-w-sm',
      'bottom-center': 'fixed bottom-4 left-1/2 -translate-x-1/2 z-50 flex flex-col-reverse gap-2 w-full max-w-sm'
    };
